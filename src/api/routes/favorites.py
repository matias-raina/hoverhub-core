...
class FavoriteRouter:
    def __init__(self):
        ...
        self.router.add_api_route("/favorites", self.add_favorite, methods=["POST"], response_model=FavoriteResponse)
        self.router.add_api_route("/favorites", self.get_favorites, methods=["GET"], response_model=list[FavoriteResponse])
